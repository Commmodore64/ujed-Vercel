...
const Index = () => {
  ...
  const handlePagoEnEfectivo = async (e) => {
    ...
    if (
      ...
      try {
        ...
        const response = await fetch("http://192.168.1.20:5000/api/generate-pdf-efectivo", {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
          },
  ...
  const handlePagoEnLineaConTarjeta = async (e) => {
    ...
    try {
      ...
      const response = await fetch(
        "http://192.168.1.20:5000/api/create-checkout",
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
          ...
          body: JSON.stringify({
            ...
            redirect_url: "http://192.168.1.20:5000/api/verify-transaction",
          }),
        }
      );
  ...
  const validarCodigoAcceso = async () => {
    try {
      ...
      const response = await fetch("http://192.168.1.20:5000/api/validar-codigo", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
